  ...
  return (
    <div style={{minHeight:'100vh',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',background:'radial-gradient(ellipse at 50% 20%, #251122 0%, #08080f 65%)',opacity:phase===2?0:1,transition:'opacity 0.5s ease'}}>
      ...
      <div style={{opacity:phase>=1?1:0,transform:phase>=1?'translateY(0)':'translateY(12px)',transition:'all 0.5s ease 0.15s',textAlign:'center',marginBottom:'40px'}}>
        <h1 style={{fontFamily:'Inter',fontWeight:'700',fontSize:'28px',color:'white',marginBottom:'6px'}}>BMI Calculator Pro</h1>
        <p style={{color:'#ec489980',fontSize:'14px'}}>Know your health.</p>
      </div>
      <div style={{opacity:phase>=1?1:0,display:'flex',flexDirection:'column',gap:'8px',alignItems:'center'}}>
        <div style={{display:"flex",alignItems:"center",gap:"12px",background:"#ffffff06",border:"1px solid #ffffff10",borderRadius:"12px",padding:"10px 16px",width:"240px"}}><span style={{fontSize:"20px"}}>💪</span><div><div style={{color:"white",fontSize:"12px",fontWeight:"500"}}>BMI calculator</div><div style={{color:"#ec489970",fontSize:"11px"}}>Weight + height</div></div></div>
        <div style={{display:"flex",alignItems:"center",gap:"12px",background:"#ffffff06",border:"1px solid #ffffff10",borderRadius:"12px",padding:"10px 16px",width:"240px"}}><span style={{fontSize:"20px"}}>📊</span><div><div style={{color:"white",fontSize:"12px",fontWeight:"500"}}>Health zones</div><div style={{color:"#ec489970",fontSize:"11px"}}>Underweight to obese</div></div></div>
        <div style={{display:"flex",alignItems:"center",gap:"12px",background:"#ffffff06",border:"1px solid #ffffff10",borderRadius:"12px",padding:"10px 16px",width:"240px"}}><span style={{fontSize:"20px"}}>📈</span><div><div style={{color:"white",fontSize:"12px",fontWeight:"500"}}>Track over time</div><div style={{color:"#ec489970",fontSize:"11px"}}>BMI history</div></div></div>
      </div>
