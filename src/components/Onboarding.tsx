...
const SLIDES=[{"accent": "#ec4899", "icon": "\ud83d\udcaa", "title": "Calculate BMI\ninstantly", "desc": "Enter height and weight in any unit. Get BMI and healthy range instantly."}, {"accent": "#db2777", "icon": "\ud83d\udcca", "title": "Understand your\nhealth category", "desc": "Color-coded zones show underweight, normal, overweight ranges."}, {"accent": "#be185d", "icon": "\ud83d\udcc8", "title": "Track BMI\nover time", "desc": "Log regularly and see how your BMI changes as you work toward goals."}];
